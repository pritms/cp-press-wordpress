...
<div class="cp_select_post_advanced_options">
	<p>
		<label>Title:</label>
		<input class="widefat" name="cp-press-section-content[<?=$num_col?>][advanced][title]" type="text" value="<?= $content['advanced']['title']; ?>"/>
	</p>
	<p>
		<label>Limit:</label>
		<input class="widefat" name="cp-press-section-content[<?=$num_col?>][advanced][limit]" type="text" value="<? $content['advanced']['limit'] != '' ? e($content['advanced']['limit']) : e('1') ?>"/>
	</p>
	<p>
		<label>Offset (the number of posts to skip):</label>
		<input class="widefat" name="cp-press-section-content[<?=$num_col?>][advanced][offset]" type="text" value="<? $content['advanced']['offset'] != '' ? e($content['advanced']['offset']) : e('0') ?>"/>
	</p>
	<p>
		<label>Order:</label>
		<select class="widefat" name="cp-press-section-content[<?=$num_col?>][advanced][order]" style="width:100%;">
	...
	<p>
		<label>Orderby:</label>
		<select class="widefat" name="cp-press-section-content[<?=$num_col?>][advanced][orderby]" style="width:100%;">
	...
	<p>
		...
		<select class="widefat" multiple="multiple" name="cp-press-section-content[<?=$num_col?>][advanced][categories][]" style="width:100%;">
	...
	<p>
		...
		<select class="widefat" multiple="multiple" name="cp-press-section-content[<?=$num_col?>][advanced][tags][]" style="width:100%;">
			<optgroup label="Tags">
