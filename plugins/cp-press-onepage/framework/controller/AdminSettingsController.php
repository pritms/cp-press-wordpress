...
class AdminSettingsController extends Controller{
	protected $uses = array('HeaderSettings', 'Settings');
	
	public function main_page(){
		$this->assign('chpress_settings', $this->Settings->findAll());
	}
	
	public function header_settings(){
		$this->assign('chpress_header_settings', $this->HeaderSettings->findAll());
	}
