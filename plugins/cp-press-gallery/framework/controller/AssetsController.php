...
class AssetsController extends \CpPressOnePage\Controller{
	...
	protected $uses = array('GallerySettings');
	
	public function __construct(){
		parent::__construct();
		$this->autoRender = false;
		$this->javascriptOptions['header'] = $this->GallerySettings->findAll();
	}
	
	public function styles(){
		wp_enqueue_style('bootstrap-lightbox');
		wp_enqueue_style('cp-press-gallery');
	}
	...
	public function javascripts(){
		...
		wp_enqueue_script('cp-press-gallery');
		wp_localize_script('cp-press-gallery', 'cpPressGalleryOptions', $this->javascriptOptions);
	}
}
