...
class AssetsController extends \CpPressOnePage\Controller{
	...
	protected $uses = array('EventSettings');
	
	public function __construct(){
		parent::__construct();
		$this->autoRender = false;
		$this->javascriptOptions['header'] = $this->EventSettings->findAll();
	}
	
	public function styles(){
		wp_enqueue_style('cp-press-event');
	}
	...
	public function javascripts(){
		wp_enqueue_script('cp-press-event-carousel');
		wp_enqueue_script('cp-press-event');
		wp_localize_script('cp-press-event', 'cpPressEventOptions', $this->javascriptOptions);
	}
}
